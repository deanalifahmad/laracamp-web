    ...
    <div class="container">
        <div class="row pb-70">
            <div class="col-lg-5 col-12 header-wrap copywriting">
                ...
                <p class="support">
                    Enroll in our Laravel Bootcamp program today <br> and take your your Laravel development skills <br> to the next level!
                </p>
                <p class="mt-5">
                ...
                <div class="row">
                    <div class="col-lg-6 col-12">
                        <div class="table-pricing paket-gila">
                            ...
                            <p>
                                <a href="{{route('checkout.create', 'gila-belajar-laravel')}}" class="btn btn-master btn-primary w-100 mt-3">
                                    Take This Plan
                                </a>
                            </p>
                        </div>
